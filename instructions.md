# Finelly — User instructions

This guide explains what to enter in each part of Finelly and where you can find that information. No financial jargon is assumed.

---

## What Finelly does

Finelly helps you keep track of **safe, income-earning assets** (like CDs and money-market accounts) and **upcoming bills or obligations**. You enter your accounts and holdings once; Finelly can then remind you when something is maturing or when a payment is due, and you can ask questions about your data and your uploaded documents.
...
| **Ingest** | Uploading or pasting document text into Finelly so you can search and ask questions about it later. |
...
| Field | What it means | Example | Where you find it |
|-------|----------------|--------|-------------------|
| **Question *** | What you want to know. | `What’s my total in CDs?`, `When does my biggest CD mature?`, `Summarize the key points of my last statement.` | You type any question; Finelly uses your data and documents to answer. |
...
**Obligations** are things you must pay by a certain date (bills, taxes, premiums, loan payments). Finelly can remind you when they’re due.
...
Click **Check status** to get **current advice** based on your accounts, positions, and obligations. Finelly looks for things like:
